...
import 'schema/ingredience_record.dart';
...
export 'schema/ingredience_record.dart';
...
/// Functions to query IngredienceRecords (as a Stream and as a Future).
Future<int> queryIngredienceRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      IngredienceRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<IngredienceRecord>> queryIngredienceRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      IngredienceRecord.collection,
      IngredienceRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<IngredienceRecord>> queryIngredienceRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
